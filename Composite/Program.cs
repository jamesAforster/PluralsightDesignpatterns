...
var topLevelFile = new Composite.File("topLevel.tct", 100);
...
Console.WriteLine($"size of topLevelDirectory 1:  {topLevelDirectory1.GetSize()}");
Console.WriteLine($"size of topLevelDirectory 2:  {topLevelDirectory2.GetSize()}");
